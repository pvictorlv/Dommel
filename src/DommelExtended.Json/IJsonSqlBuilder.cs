...
/// </summary>
public class SqlServerSqlBuilder : DommelExtended.SqlServerSqlBuilder, IJsonSqlBuilder
{
    /// <inheritdoc />
...
/// </summary>
public class MySqlSqlBuilder : DommelExtended.MySqlSqlBuilder, IJsonSqlBuilder
{
    /// <inheritdoc />
...
/// </summary>
public class PostgresSqlBuilder : DommelExtended.PostgresSqlBuilder, IJsonSqlBuilder
{
    /// <inheritdoc />
    public string JsonValue(string column, string path) => $"{column}->>'{path}'";
}
...
/// </summary>
public class SqliteSqlBuilder : DommelExtended.SqliteSqlBuilder, IJsonSqlBuilder
{
    /// <inheritdoc />
...
/// </summary>
public class SqlServerCeSqlBuilder : DommelExtended.SqlServerCeSqlBuilder, IJsonSqlBuilder
{
    /// <inheritdoc />
    public string JsonValue(string column, string path) => $"JSON_VALUE({column}, '$.{path}')";
}
