...
public static partial class DommelMapper
{
    ...
    public static ConcurrentDictionary<QueryCacheKey, string> QueryCache { get; } = new ConcurrentDictionary<QueryCacheKey, string>();
    public static IPropertyResolver PropertyResolver = new DefaultPropertyResolver();
    ...
    public static readonly Dictionary<string, ISqlBuilder> SqlBuilders = new()
    {
