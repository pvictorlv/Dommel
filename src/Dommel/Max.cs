...
public static partial class DommelMapper
{
    ...
    internal static string BuildMaxSql<TEntity, TResult>(ISqlBuilder sqlBuilder, Expression<Func<TEntity, TResult>> selector, Expression<Func<TEntity, bool>>? predicate, out DynamicParameters? parameters)
    {
