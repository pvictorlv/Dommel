...
public static partial class DommelMapper
{
    ...
    public static string BuildProjectById(ISqlBuilder sqlBuilder, Type type, object id, out DynamicParameters parameters)
    {
    ...
    public static string BuildProjectAllQuery(ISqlBuilder sqlBuilder, Type type)
    {
    ...
    public static string BuildProjectPagedQuery(ISqlBuilder sqlBuilder, Type type, int pageNumber, int pageSize)
    {
