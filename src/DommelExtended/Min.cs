...
public static partial class DommelMapper
{
    ...
    public static string BuildMinSql<TEntity, TResult>(ISqlBuilder sqlBuilder, Expression<Func<TEntity, TResult>> selector, Expression<Func<TEntity, bool>>? predicate, out DynamicParameters? parameters)
    {
