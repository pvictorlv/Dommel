...
public static partial class DommelMapper
{
    ...
    public static string BuildCountAllSql(ISqlBuilder sqlBuilder, Type type)
    {
    ...
    public static string BuildCountSql<TEntity>(ISqlBuilder sqlBuilder, Expression<Func<TEntity, bool>> predicate, out DynamicParameters parameters)
    {
